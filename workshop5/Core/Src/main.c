...
#define EVENT_GAP_MS      51
#define CYCLE_GAP_MS      600
/* USER CODE END PD */
...
static const BeepEvent beepEvents[] = {
  {BEEP_D5, 140, GPIO_PIN_13},
  {BEEP_G5, 140, GPIO_PIN_15},
  {BEEP_E5, 220, GPIO_PIN_14},
  {BEEP_C5, 280, GPIO_PIN_12},

  {BEEP_F5, 150, GPIO_PIN_12},
  {BEEP_A5, 150, GPIO_PIN_15},
  {BEEP_C6, 240, GPIO_PIN_13},
  {BEEP_A5, 280, GPIO_PIN_14},

  {BEEP_B5, 140, GPIO_PIN_15},
  {BEEP_G5, 140, GPIO_PIN_14},
  {BEEP_E5, 220, GPIO_PIN_13},
  {BEEP_D5, 300, GPIO_PIN_12},

  {BEEP_C5, 150, GPIO_PIN_12},
  {BEEP_E5, 150, GPIO_PIN_14},
  {BEEP_G5, 220, GPIO_PIN_15},
  {BEEP_B5, 280, GPIO_PIN_13},

  {BEEP_C6, 140, GPIO_PIN_12},
  {BEEP_A5, 140, GPIO_PIN_15},
  {BEEP_F5, 220, GPIO_PIN_14},
  {BEEP_D5, 280, GPIO_PIN_13},

  {BEEP_E5, 160, GPIO_PIN_14},
  {BEEP_G5, 160, GPIO_PIN_15},
  {BEEP_D5, 220, GPIO_PIN_13},
  {BEEP_C5, 430, GPIO_PIN_12}
};

static const uint32_t beepEventsLength = sizeof(beepEvents) / sizeof(beepEvents[0]);
/* USER CODE END PV */
...
static void CS43L22_PlayEvent(uint8_t tone_code, uint16_t active_ms, uint16_t led_pin);
static void PlayBeepEventsOnce(void);
static void PlayBeepEventsThreeTimes(void);
...
static void CS43L22_PlayEvent(uint8_t tone_code, uint16_t active_ms, uint16_t led_pin)
{
  ...
  CS43L22_WriteReg(CS43L22_REG_BEEP_FREQ_ONTIME, tone_code | 0x0F);
...
static void PlayBeepEventsOnce(void)
{
  for (uint32_t i = 0; i < beepEventsLength; i++) {
    CS43L22_PlayEvent(beepEvents[i].tone_code, beepEvents[i].active_ms, beepEvents[i].led_pin);
    HAL_Delay(EVENT_GAP_MS);
  }
}

static void PlayBeepEventsThreeTimes(void)
{
  for (uint32_t round = 0; round < BEEP_REPEAT_COUNT; round++) {
    PlayBeepEventsOnce();
